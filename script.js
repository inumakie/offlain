    ...
    content.innerHTML = `
        <div>
            ...
            <p style="margin-bottom: 40px;">
                ...
                lineas entrecortadas que dibujan las olas con una luz cristalina y bordes de arcoiris,
                pero no había agua a la vista. la habitación parecía muy pequeña, pero conforme empece
                a caminar y moverme, cambiaba su tamaño. cuanto más me alejaba
            ...
            <h2>UUNO</h2>
            <p style="margin-bottom: 40px;">
            Aparece una mancha gigante en la atmósfera. Una formación de luces con forma de algas marinas levitan sobre el polo sur del planeta. Todas las personas sufren una alteración espontánea del sistema nervioso, que consiste en una momentanea falta de sensibilidad y un instinto por electrocutarse. Por un periodo de tiempo, nada duele ni daña y todos sienten sed de electricidad. Billones de personas dejan de lado lo que sea que estaban haciendo y comienzan a romper cables de todo tipo para exponer los filamentos conductores y saborear una dosis fuerte de electrones. Algunas personas muerden lamparas encendidas. Hay suicidios masivos en las estaciones de subte. Todo el ambiente se llena de flashes de luz blanca, humo y vapor. La mancha en la atmósfera desaparece y las luces con forma de algas salen disparadas a otro lugar del cosmos.
            </p>

            <h2>cero</h2>
            <p style="margin-bottom: 40px;">
            la fantasia es lo más real que existe, "la realidad" es un algoritmo al que sometemos el cuerpo para vivir,
            pero para que vas a someter el cuerpo a la vida si no te vas a permitir florecer tu cerebro?
            darle colores y sonidos y comerlo como una sandia con el agua chorreando por las comisuras de los labios.
            ecstasis.
            </p>
            ...
            En un momento sentí que un cuervo gigante se apoyaba contra mi cuerpo.
            Era un cuervo de una altura exactamente igual a la mía.
            Podía sentir la suavidad de las alas y las plumas tocando mis brazos.
            A veces apoyaba su pico en la punta de mi nariz y entonces sentía como crecían
            ramas de árbol dentro de mi cuerpo. Me hacía volverme consciente de mi propia respiración.
            El cuervo telepáticamente transmitía tranquilidad. Se alimentaba de
            mi ansiedad, miedo y dolor. El animal era muy sabio, en una ocasión me dijo que
            necesitaba mi ansiedad como una planta necesita mi dioxido de carbono.
            me dijo eso cuando pensé que el hecho de que se alimente de emociones
            negativas podría ser perjudicial para su salud. o darle un leve dolor de estómago.
            "Entendes tan poco" dijo.            
            </p>

            <h2>invoka</h2>
            <p style="margin-bottom: 40px;">
            Durante mis lecturas aleatorias de material esotérico pesado en las profundidades
            de la madrugada, mi mente se alinea con otro plano y soy susceptible a ver 
            cosas feas. demonios.
            solía quedarme petrificado por periodos largos de tiempo.
            el miedo me paralizaba.
            pero un día el miedo me canso o aburrio y entendi que
            si el diablo quiere lastimarte, ya lo habría hecho.
            y que la realidad es que no puede hacer más que provocarte miedo.
            no es su culpa tener hambre de miedo ajeno en vez de hambre de un sanguchito de miga con coca y papas fritas.
            </p>
            ...
            todo tipo de piedras hermosas de todos los colores.
            comence a subir las escaleras
            y al llegar a la cima de la escalera apareció otra puerta.
            salia brillo por los bordes del marco. habia olor a sal.
            ¿sentia el cuerpo?
            <p/>
